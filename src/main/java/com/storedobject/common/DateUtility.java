...
public class DateUtility {
     ...
     *
     * @param date Date
     * @return  timestamp corresponding to the date passed with time set to end time of that day
     */
     ...
     * @param <D> Date type.
     */
    public static <D extends java.util.Date> int getWeekOfYear(D date) {
        return get(date, WEEK_OF_YEAR);
    }
     ...
     * @param <D> Date type.
     */
    public static <D extends java.util.Date> int getDayOfYear(D date) {
        return get(date, DAY_OF_YEAR);
    }
     ...
     * @param <D> Date type.
     */
    public static <D extends java.util.Date> int getHourOfYear(D date) {
        GregorianCalendar c = new GregorianCalendar();
        c.setTime(date);
